...
public class NoobChain {
	...
	public static void main(String[] args) throws IOException {	
		...
		//System.out.println("\nWalletA is Attempting to send funds (40) to WalletB...");
		          System.out.println("Enter Amount Of Money To Send From Wallet A To B:");
		...
		//System.out.println("\nWallet B is Attempting to send funds (20) to WalletA...");
                System.out.println("Enter Amount Of Money To Send From Wallet B To A:");
                amount=sc.nextInt();
...
//addBlock(new Block("Hi im the first block", "0"));50
